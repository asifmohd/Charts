...
public class ChartFill: NSObject
{
    ...
    public init(CGImage: CoreGraphics.CGImage, tiled: Bool)
    {
    ...
    public convenience init(CGImage: CoreGraphics.CGImage)
    {
    ...
    public init(CGLayer: CoreGraphics.CGLayer)
    {
        _type = .layer
        _layer = CGLayer
    }
    ...
    public class func fillWithCGColor(_ CGColor: CoreGraphics.CGColor) -> ChartFill
    {
    ...
    public class func fillWithCGImage(_ CGImage: CoreGraphics.CGImage, tiled: Bool) -> ChartFill
    {
    ...
    public class func fillWithCGImage(_ CGImage: CoreGraphics.CGImage) -> ChartFill
    {
    ...
    public class func fillWithCGLayer(_ CGLayer: CoreGraphics.CGLayer) -> ChartFill
    {
